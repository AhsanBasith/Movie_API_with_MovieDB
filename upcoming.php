...
include 'assets/api/upcoming_movie.php';
    ...
    <div class="content-header">
        <div class="container">
            ...
            <div class="jumbotron jumbotron-fluid bg-white shadow" style="background-image: url('https://img.freepik.com/free-vector/organic-white-backgroun_1199-324.jpg?w=740&t=st=1719008262~exp=1719008862~hmac=74a1abe47fc07f618d8aeea761ceb19e77fd65794492281bd6715ebc2b9f53bb');">
                <div class="container">
                    <h1 class="display-4 font-weight-bold">UpComing Movie.</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <?php
                        foreach ($upcoming_movie->results as $uc) {
                            $title         = $uc->title;
                            $id         = $uc->id;
                            $release    = $uc->release_date;
                                    ...
                                    <div class="text-card overlay position-absolute top-0 bottom-0 left-0 right-0 w-100 h-100">
                                        <div class="position-absolute top-50 start-50 translate-middle text-center w-100">
                                            ...
                                            <span class="badge badge-dark">
                                                <?= date('d F Y', strtotime($uc->release_date)); ?>
                                            </span>
                                            <h6>
                                                <?= $uc->adult ?>
                                            </h6>
                                            <a href="movie.php?id=<?= $uc->id ?>" class="btn btn-primary">Lihat Film</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
