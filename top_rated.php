...
include 'assets/api/top_rated_movie.php';
    ...
    <div class="content-header">
        <div class="container">
            ...
            <div class="jumbotron jumbotron-fluid bg-white shadow" style="background-image: url('https://img.freepik.com/free-vector/organic-white-backgroun_1199-324.jpg?w=740&t=st=1719008262~exp=1719008862~hmac=74a1abe47fc07f618d8aeea761ceb19e77fd65794492281bd6715ebc2b9f53bb');">
                <div class="container">
                    <h1 class="display-4 font-weight-bold">Top Rated Movie.</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <?php
                        foreach ($toprated_movie->results as $tr) {
                            $title         = $tr->title;
                            $id         = $tr->id;
                            $release    = $tr->release_date;
                        ...
                        ?>
                            <div class="col-md-4 col-lg-3 col-sm-4">
                                <div class="card ml-2">
                                    <img src="<?= $poster ?>" class="card-img-top rounded-lg" alt="...">
                                    <div class="text-card overlay position-absolute top-0 bottom-0 left-0 right-0 w-100 h-100">
                                        <div class="position-absolute top-50 start-50 translate-middle text-center w-100">
                                            ...
                                            <span class="badge badge-dark">
                                                <?= date('d F Y', strtotime($tr->release_date)); ?>
                                            </span>

                                            <br>
                                            <span class="badge badge-dark mb-3">Vote : <?= $tr->vote_average ?></span>
                                            <br>
                                            <a href="movie.php?id=<?= $tr->id ?>" class="btn btn-primary">Lihat Film</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
