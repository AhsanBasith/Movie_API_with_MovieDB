...
curl_setopt_array($curl, [
    CURLOPT_URL => "https://api.themoviedb.org/3/movie/" . $id_movie . "/videos?include_type=trailer&api_key=015f74b1eb808f7f3930cb43565009b4",
...
if ($err) {
    ...
    $movie_video_id = json_decode($response3);
}
