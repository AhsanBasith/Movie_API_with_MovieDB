...
curl_setopt_array($curl, [
    CURLOPT_URL => "https://api.themoviedb.org/3/movie/popular?language=en-US&page=1?api_key=015f74b1eb808f7f3930cb43565009b4",
...
if ($err) {
    ...
    $movie_populer = json_decode($response13);
}
